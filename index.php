...
<head>
  ...
  <link rel="preload" href="https://hayola.hornspeed.com/img/tweety.webp" as="image">
</head>
<body>
  ...
  <audio id="olvie-sound" preload="auto">
    <source src="assets/sounds/olvie.mp3" type="audio/mpeg">
  </audio>
  <audio id="migmig-sound" preload="auto">
    <source src="https://hayola.hornspeed.com/assets/sounds/Mig-Mig.mp3" type="audio/mpeg">
  </audio>
